            ...
            <div className='flex gap-5'>
                <aside class="flex h-full w-1/5 flex-col gap-4">
                    <div class="flex flex-col">
                        <div class="mb-1 flex items-center justify-between rounded-r-xl border-l-4 bg-white px-2 py-3 border-indigo-600 cursor-pointer gap-3">
                    ...
                    <div class="flex flex-col items-start gap-4">
                        <a target="_blank" rel="noopener noreferrer" class="child:p-0" href="https://pro.billdr.co/resources/video-tutorials">
                            <button class="text-indigo-600 hover:text-black flex items-center cursor-pointer rounded-xl box-border outline-none transition-colors ease-in-out duration-300 flex-wrap flex-row gap-1 justify-start bg-transparent text-primary hover:text-secondary p-0 text-sm font-normal" type="button" data-headlessui-state="">
                                Tutorial videos
