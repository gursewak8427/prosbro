    ...
    <div className="w-[270px] max-h-screen h-screen bg-slate-50 fixed top-0 left-0 overflow-scroll flex flex-col justify-between" style={{ overflow: 'auto' }}>
      ...
      <div className="border-t p-2 mt-10  bg-white">
        <div className="text-sm">
          <h2 className='text-sm text-gray-600 items-center hover:bg-gray-200 cursor-pointer p-4 rounded-lg'><HelpIcon className='text-gray-500 text-lg' /> Help</h2>
          <h2 className='text-sm text-gray-600 items-center hover:bg-gray-200 cursor-pointer p-4 rounded-lg'>< AccountCircleIcon className='text-indigo-500' /> Gurvinder Singh</h2>
        </div>
      </div>
    </div>
  );
