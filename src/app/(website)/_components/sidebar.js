...
const Sidebar = () => {
  ...
  return (
    <div className="w-[270px] border-r-2 max-h-screen h-screen bg-slate-50 fixed top-0 left-0 overflow-scroll flex flex-col justify-between p-3" style={{ overflow: 'auto' }}>
      <div className="top">
