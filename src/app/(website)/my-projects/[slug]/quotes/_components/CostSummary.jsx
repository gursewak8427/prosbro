...
export const CostSummary = ({ amountDisplayType, displayColumns, isYourView }) => {
    ...
    return <div className="mt-4 bg-gray-100 flex flex-col gap-3">
        ...
        {
            !isYourView && <div className="flex flex-col gap-3">
                <h1 className='my-2 font-semibold'>Cost summary</h1>
                <table className="w-full bg-white">
                    <thead className="bg-primary">
                        <tr>
                            <th className="rounded-l pl-4 py-4 text-left text-white p-2 w-2/5">Task</th>
                            {
                                displayColumns?.quantities && <th className="py-4 text-white p-2 text-center">Quantity</th>
                            }
                            {
                                displayColumns?.materialpluslabourcost && <>
                                    <th className="py-4 text-white p-2 text-center">Material Cost</th>
                                    <th className="py-4 text-white p-2 text-center">Labour Cost</th>
                                </>
                            }
                            {
                                displayColumns?.markupamount && <th className="py-4 text-white p-2 text-center">Markup</th>
                            }
                            <th className="rounded-r py-4 pr-4 text-white text-right p-2 pr-2">Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        {quotereview?.map((item, index) => (
                            <>
                                <tr>
                                    <td colspan={getColSpan1()} className="px-4 font-semibold text-lg pt-4">
                                        {item.task?.name}
                                    </td>
                                    <td className="text-center pr-2 px-4">
                                        {
                                ...
                                {item.subtasks &&
                                    item.subtasks.map((task, taskIndex) => (
                                        <tr key={taskIndex} className='w-full py-4 border-b'>
                                            ...
                                            {
                                                displayColumns?.quantities && <td className='py-4 text-center px-4'>{task?.quantity} {task?.quantitytype}</td>
                                            }
                                            {
                                                displayColumns?.materialpluslabourcost && <td className='py-4 text-center px-4'>${task?.material || 0}</td>
                                            }
                                            {
                                                displayColumns?.materialpluslabourcost && <td className='py-4 text-center px-4'>${task?.labour || 0}</td>
                                            }
                                            {
                                                displayColumns?.markupamount && <td className='py-4 text-center px-4'>${task?.markup || 0}</td>
                                            }

                                            {["perCategoriesPlusTask"]?.includes(amountDisplayType) && <td className="text-right pr-2 px-4">${task?.totalcost}</td>}
                                        </tr>
                                    ))}
                            </>
                        ))}
                    ...
                    <div className="flex flex-row justify-end">
                        <div className="w-1/3">
                            <div className="flex justify-between items-center mb-3">
                                <div className="text-gray-700 text-md">Subtotal</div>
                                <div className="text-gray-700 text-md">${quote?.subtotalbill}</div>
                            </div>
                            <div className="flex justify-between items-center mb-3">
                                <div className="text-gray-600 text-md">GST 5%</div>
                                <div className="text-gray-600 text-md">$5,413.24</div>
                            </div>
                            <div className="flex justify-between items-center font-bold text-lg">
                                <div className="text-gray-700 text-md">Total</div>
                                <div className="text-gray-700 text-md">$113,678.04</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col">
            <h1 className='font-bold text-lg text-gray-700'>Construction schedule</h1>
            {/* Make table here  */}
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col">
            <h1 className='font-bold text-lg text-gray-700'>Quote validity</h1>
            <p className='text-gray-600'>7 days - August 22nd 2024</p>
        </div>

        {/* Terms and Conditions */}
        <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col gap-4">
            <h1 className='font-bold text-lg text-black mb-2'>Terms and Conditions</h1>

            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Purpose</h2>
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Scope of Work</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Security and Maintenance of the Premises</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Insurance</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Payment Terms</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Change Orders</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Warranties</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Default on the part of the Contractor or Client and termination of the contract</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Unilateral termination of the contract</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Material Price Fluctuation</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Governing Law</h2>
                <p className="text-gray-600">
            ...
            <section className="">
                <h2 className="font-bold text-lg text-gray-700 mb-2">Entire Agreement</h2>
                <p className="text-gray-600">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col">
            <h1 className='font-bold text-lg text-gray-700 mb-2'>Attached documents</h1>
            {/* Files List here */}
        </div>

        <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col">
            <h1 className='font-bold text-lg text-gray-700 mb-2'>Signatures</h1>
            {/* Make table here  */}
