      ...
      <div className="w-full bg-gray-200 min-h-screen">
        <div className="max-w-screen mx-auto p-6 bg-white shadow-md rounded-lg w-full h-screen flex justify-between">
          <div className="w-1/2 p-8 flex flex-col justify-center">
            ...
            <h2 className="text-3xl font-bold mb-6 mt-5 ">Login</h2>
            <div className="mb-4">
            ...
            <div className="mb-4 flex justify-between">
              <button className="bg-gray-300 w-full text-gray-600 px-4 py-2 rounded-xl h-14 hover:bg-gray-400 transition-colors" onClick={loginhandle}>
                Login
              </button>
            </div>
            <hr className="mb-4" />
          ...
          <div className="w-2/3 h-full">
            <img
              src="https://app.billdr.co/_next/image?url=%2Fassets%2Fimages%2Fsignup-step1.jpg&w=3840&q=100"
              alt="Sign Up Step"
